 ...
 * @author dg3861
 */
public class Queu_BajaNatural_job implements Job {
   ...
   @Override
    public void execute(JobExecutionContext context) throws JobExecutionException {
             ...
             String insertabitacora= "SELECT B.ID_TOKEN, A.NTICKET, B.ID_USUARIO, B.ID_LOGIN, 6, B.FECHA_ASIGNACION, sysdate, sysdate, B.ID_PRIORIDAD, B.BAND_REASIGNADO, sysdate  FROM PW_QUEUE_TOKEN  A\n" +
                    "						INNER JOIN (\n" +
